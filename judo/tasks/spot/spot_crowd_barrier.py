...
XML_PATH = str(MODEL_PATH / "xml/spot_components/spot_crowd_barrier.xml")
...
@dataclass
class SpotCrowdBarrierConfig(SpotBaseConfig):
...
class SpotCrowdBarrier(SpotBase[SpotCrowdBarrierConfig]):
    ...
    def success(self, model: MjModel, data: MjData, config: SpotCrowdBarrierConfig, metadata: dict[str, Any] | None = None) -> bool:
