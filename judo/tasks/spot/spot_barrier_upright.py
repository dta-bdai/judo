...
class SpotBarrierUpright(SpotBase[SpotBarrierUprightConfig]):
    ...
    def reward(
        ...
        gripper_orientation_reward = (
            -config.w_gripper_orientation * total_orientation_error.mean(axis=-1)
        )
    ...
    def success(self, model: MjModel, data: MjData, config: SpotBarrierUprightConfig, metadata: dict[str, Any] | None = None) -> bool:
