...
class SpotChairPushConfig(SpotBaseConfig):
    """Config for the spot chair pushing task."""
...
class SpotChairPush(SpotBase):
    """Task getting Spot to push a chair to a goal location."""

    name: str = "spot_chair_push"
    config_t: type[SpotChairPushConfig] = SpotChairPushConfig

    def __init__(self, model_path: str = XML_PATH, config: SpotChairPushConfig | None = None) -> None:
    ...
    def reward(
        ...
        """Reward function for the Spot chair pushing task."""
