...
class SpotTirePush(SpotBase):
    ...
    def reward(
        ...
        object_orientation_reward = -config.w_tire_orientation * np.abs(
    ...
    def success(self, model: MjModel, data: MjData, config: SpotTirePushConfig, metadata: dict[str, Any] | None = None) -> bool:
