...
class SpotRackPush(SpotBase):
    ...
    def success(self, model: MjModel, data: MjData, config: SpotRackPushConfig, metadata: dict[str, Any] | None = None) -> bool:
    ...
    def failure(self, model: MjModel, data: MjData, config: SpotRackPushConfig, metadata: dict[str, Any] | None = None) -> bool:
