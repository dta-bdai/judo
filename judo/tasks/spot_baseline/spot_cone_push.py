...
class SpotConePushBaseline(SpotLocomotion):
    ...
    def __init__(
        ...
        config: SpotConePushBaselineConfig | None = None,
    ) -> None:
    ...
    def reward(
        ...
        cone_goal = np.asarray(self.config.cone_goal_position, dtype=np.float64)
    ...
    def success(self, model: MjModel, data: MjData, metadata: dict[str, Any] | None = None) -> bool:
        ...
        goal_pos = np.array(self.config.cone_goal_position)
