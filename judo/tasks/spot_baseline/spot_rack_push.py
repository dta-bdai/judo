...
class SpotRackPushBaseline(SpotLocomotion):
    ...
    def __init__(
        ...
        config: SpotRackPushBaselineConfig | None = None,
    ) -> None:
    ...
    def reward(
        ...
        rack_goal = np.asarray(self.config.rack_goal_position, dtype=np.float64)
    ...
    def success(self, model: MjModel, data: MjData, metadata: dict[str, Any] | None = None) -> bool:
        ...
        goal_pos = np.array(self.config.rack_goal_position)
