...
class SpotBoxPushBaseline(SpotLocomotion):
    ...
    def __init__(
        ...
        config: SpotBoxPushBaselineConfig | None = None,
    ) -> None:
    ...
    def reward(
        ...
        box_goal = np.asarray(self.config.box_goal_position, dtype=np.float64)
    ...
    def success(self, model: MjModel, data: MjData, metadata: dict[str, Any] | None = None) -> bool:
        ...
        goal_pos = np.array(self.config.box_goal_position)
