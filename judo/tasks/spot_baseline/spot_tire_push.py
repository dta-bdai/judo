...
class SpotTirePushBaseline(SpotLocomotion):
    ...
    def __init__(
        ...
        config: SpotTirePushBaselineConfig | None = None,
    ) -> None:
    ...
    def reward(
        ...
        tire_goal = np.asarray(self.config.tire_goal_position, dtype=np.float64)
    ...
    def success(self, model: MjModel, data: MjData, metadata: dict[str, Any] | None = None) -> bool:
        ...
        goal_pos = np.array(self.config.tire_goal_position)
