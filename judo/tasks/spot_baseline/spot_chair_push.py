...
class SpotChairPushBaseline(SpotLocomotion):
    ...
    def reward(
        ...
        sensors: np.ndarray,
        controls: np.ndarray,
        config: SpotChairPushBaselineConfig,
        ...
        chair_goal = np.asarray(config.chair_goal_position, dtype=np.float64)
    ...
    def success(self, model: MjModel, data: MjData, config: SpotChairPushBaselineConfig, metadata: dict[str, Any] | None = None) -> bool:
        ...
        goal_pos = np.array(config.chair_goal_position)
    ...
    def failure(self, model: MjModel, data: MjData, config: SpotChairPushBaselineConfig, metadata: dict[str, Any] | None = None) -> bool:
